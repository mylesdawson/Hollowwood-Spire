...
public class JumpConfig
{
    ...
    public JumpConfig(int baseMaxJumps = 2, float baseJumpHeight = 100f, float baseGravityUpMultiplier = 2f, float baseWallJumpVelocityX = 10f, float baseHitJumpVelocityX = 12f)
    {
